...
import com.jeluchu.jchuplayer.core.mode.contentScale
import com.jeluchu.jchuplayer.core.mode.resize
import com.jeluchu.jchuplayer.core.states.ControllerVisibility
...
fun Media(
    ...
    Box(
        ...
        // controller
        if (controller != null && state.playerError == null) {
            LaunchedEffect(Unit) {
